...
std::string common::base64_encode(std::string input) {
...
std::string common::base64_encode(const unsigned char* buf, int bufLen) {
	// BYTE const* buf = (const unsigned char*)(input.c_str());
	// unsigned int bufLen = input.length();
